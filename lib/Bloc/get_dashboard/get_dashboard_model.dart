...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    allEvents:
        json["allEvents"] == null
            ? []
            : List<UpcomingEvent>.from(json["allEvents"]!.map((x) => UpcomingEvent.fromJson(x))),
    ...
    upcomingBookingRequests:
        json["upcomingBookingRequests"] == null
            ? []
            : List<UpcomingBookingRequest>.from(
              json["upcomingBookingRequests"]!.map((x) => UpcomingBookingRequest.fromJson(x)),
            ),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "allEvents": allEvents == null ? [] : List<dynamic>.from(allEvents!.map((x) => x.toJson())),
    "upcomingEvents": upcomingEvents == null ? [] : List<dynamic>.from(upcomingEvents!.map((x) => x.toJson())),
    "upcomingBookingRequests":
        upcomingBookingRequests == null ? [] : List<dynamic>.from(upcomingBookingRequests!.map((x) => x.toJson())),
...
class Revenue {
  ...
  Revenue({this.totalRevenue, this.totalTransactions});

  factory Revenue.fromJson(Map<String, dynamic> json) =>
      Revenue(totalRevenue: json["totalRevenue"], totalTransactions: json["totalTransactions"]);

  Map<String, dynamic> toJson() => {"totalRevenue": totalRevenue, "totalTransactions": totalTransactions};
}
...
class Analytics {
  ...
  Analytics({this.profileViews, this.upcomingEventsCount, this.pendingRequestsCount, this.totalEventsCount});

  factory Analytics.fromJson(Map<String, dynamic> json) => Analytics(
    profileViews: json["profileViews"],
    upcomingEventsCount: json["upcomingEventsCount"],
    totalEventsCount: json["totalEventsCount"],
...
class UpcomingBookingRequest {
  ...
  factory UpcomingBookingRequest.fromJson(Map<String, dynamic> json) => UpcomingBookingRequest(
    id: json["id"],
    requestedDates:
        json["requestedDates"] == null
            ? []
            : List<DateTime>.from(json["requestedDates"]!.map((x) => DateTime.parse(x))),
    status: json["status"],
    notes: json["notes"],
