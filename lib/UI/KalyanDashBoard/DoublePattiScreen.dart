...
class DoublePattiScreen extends StatefulWidget {
  const DoublePattiScreen({Key? key}) : super(key: key);

  @override
  State<DoublePattiScreen> createState() => _DoublePattiScreenState();
}

class _DoublePattiScreenState extends State<DoublePattiScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:  Text("$appName Double Patti Dashboard"),
      ),
      body: Column(
        children: [
          Padding(
