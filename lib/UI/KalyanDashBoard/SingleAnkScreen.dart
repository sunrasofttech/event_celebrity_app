...
import 'package:tatamatka/Widget/ButtonWidget.dart';

class SingleAnkScreen extends StatefulWidget {
  const SingleAnkScreen({Key? key}) : super(key: key);
  @override
  State<SingleAnkScreen> createState() => _SingleAnkScreenState();
}

class _SingleAnkScreenState extends State<SingleAnkScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("$appName Single Ank Dashboard"),
      ),
      body: Column(
        children: [
          Padding(
