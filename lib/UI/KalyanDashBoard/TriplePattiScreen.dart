...
class TriplePattiScreen extends StatefulWidget {
  const TriplePattiScreen({Key? key}) : super(key: key);

  @override
  State<TriplePattiScreen> createState() => _TriplePattiScreenState();
}

class _TriplePattiScreenState extends State<TriplePattiScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("$appName Triple Patti Dashboard"),
      ),
      body: Column(
        children: [
          Padding(
