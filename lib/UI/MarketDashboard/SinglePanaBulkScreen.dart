...
class SinglePanaBulkScreen extends StatefulWidget {
  final String id;
  final String gameType;
  final String marketName;
  final bool isOnlyClose;

  const SinglePanaBulkScreen({Key? key, required this.id, required this.gameType, required this.isOnlyClose, required this.marketName})
    : super(key: key);

  @override
  State<SinglePanaBulkScreen> createState() => _SinglePanaBulkScreenState();
}

class _SinglePanaBulkScreenState extends State<SinglePanaBulkScreen> {
